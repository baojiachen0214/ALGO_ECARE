...
setup(
    ...
    author='Jiachen Bao',  # 项目的作者
    description='micro_expression_recognition',  # 项目的一个简短描述
    ...
    author_email='thestein@foxmail',  # 作者的有效邮箱地址
    url='https://gitee.com/bao-jiachen/e-care',  # 项目的源码地址
    license='Apache-2.0',
